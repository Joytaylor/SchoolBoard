...
$_mod.installed("schoolboard$1.0.0", "marko", "4.18.24");
...
$_mod.def("/schoolboard$1.0.0/hello.marko", function(require, exports, module, __filename, __dirname) { // Compiled using marko@4.18.24 - DO NOT EDIT
"use strict";
...
var marko_template = module.exports = require('/marko$4.18.24/src/vdom'/*"marko/src/vdom"*/).t(),
    ...
    marko_componentType = marko_registerComponent("/schoolboard$1.0.0/hello.marko", function() {
      return module.exports;
    }),
...
$_mod.def("/schoolboard$1.0.0/client", function(require, exports, module, __filename, __dirname) { var helloComponent = require('/schoolboard$1.0.0/hello.marko'/*"./hello"*/);

helloComponent.renderSync({ name: "Marko" }).appendTo(document.body);
});
$_mod.run("/schoolboard$1.0.0/client");
